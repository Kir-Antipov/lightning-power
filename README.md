...
[![GitHub build status](https://img.shields.io/github/workflow/status/Kir-Antipov/lightning-power/build-artifacts/1.18.x/dev?cacheSeconds=3600)](https://github.com/Kir-Antipov/lightning-power/actions/workflows/build-artifacts.yml)
